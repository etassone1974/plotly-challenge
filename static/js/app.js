...
function displayDemoInfo (subjectID) {
    ...
    let json_file = "../../data/samples.json";
...
function displayPlots (subjectID) {
    ...
    d3.json(json_file).then(function(data) {
        ...
        let  gaugeData = [{
            // Set type and mode
            // gauge+number indicates gauge and numeric display
            type: "indicator",
            mode: "gauge+number",
            // Retrieve washing frequency from metadata for subject
            value: subject_metadata[0].wfreq,
            // Title gauge chart
            title: { text: "Scrubs per Week" },
            // Set options for gauge
            // Axis should be from 0 to 9
            // Tickmode is set to "array" to specify values for gauge
            // Tick values should be from 0 to 9
            // Tick text i.e. display of ticks should be from 0 to 9
            gauge: {
                axis: { 
                    range: [0, 9],
                    tickwidth: 2, 
            ...
            // Set gauge bar to "darkblue"
            bar: { color: "darkblue" },
            // Make gauge progressively darker with higher washing frequency
            steps: [
